...
<body>
    ...
    <section id="photostack-1" class="photostack photostack-start">
        <div>
            <figure>
                <a href="#" class="photostack-img"><img src="<?php echo e(asset('storage/profiles/hokkaidou.jpg')); ?>" alt="img01" /></a>
                <figcaption>
                    <h2 class="photostack-title">Hokkaidou</h2>
                </figcaption>
            </figure>
            <figure>
                <a href="#" class="photostack-img"><img src="<?php echo e(asset('storage/profiles/date.jpg')); ?>" alt="img02" /></a>
                <figcaption>
                    <h2 class="photostack-title">Miyagi</h2>
                </figcaption>
            </figure>
            <figure data-dummy>
                    <a href="#" class="photostack-img"><img src="<?php echo e(asset('storage/profiles/yamagata.jpg')); ?>" alt="img12" /></a>
                    <figcaption>
                        <h2 class="photostack-title">Yamagata</h2>
                    </figcaption>
                </figure>
            <figure>
                <a href="#" class="photostack-img"><img src="<?php echo e(asset('storage/profiles/ibaraki.jpg')); ?>" alt="img03" /></a>
                <figcaption>
                    <h2 class="photostack-title">Ibaraki</h2>
                </figcaption>
            </figure>
            <figure>
                <a href="#" class="photostack-img"><img src="<?php echo e(asset('storage/profiles/totigi.jpg')); ?>" alt="img04" /></a>
                <figcaption>
                    <h2 class="photostack-title">Totigi</h2>
                </figcaption>
            </figure>
            <figure>
                <a href="#" class="photostack-img"><img src="<?php echo e(asset('storage/profiles/yamanasi.jpg')); ?>" alt="img05" /></a>
                <figcaption>
                    <h2 class="photostack-title">Ymanasi</h2>
                </figcaption>
            </figure>
            <figure data-dummy>
                    <a href="#" class="photostack-img"><img src="<?php echo e(asset('storage/profiles/gunma.jpg')); ?>" alt="img13" /></a>
                    <figcaption>
                        <h2 class="photostack-title">Gunma/h2>
                    </figcaption>
                </figure>
            <figure>
                <a href="#" class="photostack-img"><img src="<?php echo e(asset('storage/profiles/kana.jpg')); ?>" alt="img06" /></a>
                <figcaption>
            ...
            <figure data-dummy>
                ...
                <figure data-dummy>
                    <a href="#" class="photostack-img"><img src="<?php echo e(asset('storage/profiles/kouchi.jpg')); ?>" alt="img11" /></a>
                    <figcaption>
                        <h2 class="photostack-title">Kochi</h2>
                    </figcaption>
                </figure>
                <figure data-dummy>
                    <a href="#" class="photostack-img"><img src="<?php echo e(asset('storage/profiles/hukuoka.jpg')); ?>" alt="img14" /></a>
                    <figcaption>
                        <h2 class="photostack-title">Hukuoka</h2>
                    </figcaption>
                </figure>
                <figure data-dummy>
                    <a href="#" class="photostack-img"><img src="<?php echo e(asset('storage/profiles/kumamoto.jpg')); ?>" alt="img15" /></a>
                    <figcaption>
                        <h2 class="photostack-title">Kumamoto</h2>
                    </figcaption>
                </figure>
                <figure data-dummy>
                    <a href="#" class="photostack-img"><img src="<?php echo e(asset('storage/profiles/okinawa.jpg')); ?>" alt="img16" /></a>
                    <figcaption>
    ...
    <div class="container">
        <div class="row mt presentation">
            ...
            <div class="col-lg-4 col-md-4">
                ...
                <a href="<?php echo e(route('login')); ?>" class="stretched-link">ログインして始める</a>
            </div>
        </div>
            ...
            <ul>
                <li class="cbp-item identity">
                    <a class="cbp-caption cbp-lightbox" data-title="Image" href="storage/profiles/tokyotower.jpg">
                        <div class="cbp-caption-defaultWrap">
                            <img src="<?php echo e(asset('storage/profiles/tokyotower.jpg')); ?>" alt="" class="img-responsive">
                        </div>
                ...
                <li class="cbp-item web-design">
                    <a class="cbp-caption cbp-lightbox" data-title="Image" href="storage/profiles/totigi.jpg">
                        <div class="cbp-caption-defaultWrap">
                            <img src="<?php echo e(asset('storage/profiles/totigi.jpg')); ?>" alt="" class="img-responsive">
                        </div>
                        <div class="cbp-caption-activeWrap">
                            <div class="cbp-l-caption-alignCenter">
                                <div class="cbp-l-caption-body">
                ...
                <li class="cbp-item graphic identity">
                    <a class="cbp-caption cbp-lightbox" data-title="Image" href="storage/profiles/IMG_0815.JPG">
                        <div class="cbp-caption-defaultWrap">
                            <img src="<?php echo e(asset('storage/profiles/IMG_0815.JPG')); ?>" alt="" class="img-responsive">
                        </div>
                        <div class="cbp-caption-activeWrap">
                            <div class="cbp-l-caption-alignCenter">
                                <div class="cbp-l-caption-body">
                ...
                <li class="cbp-item graphic">
                    <a class="cbp-caption cbp-lightbox" data-title="Image" href="storage/profiles/gunma.jpg">
                        <div class="cbp-caption-defaultWrap">
                            <img src="<?php echo e(asset('storage/profiles/gunma.jpg')); ?>" alt="" class="img-responsive">
                        </div>
                        <div class="cbp-caption-activeWrap">
                            <div class="cbp-l-caption-alignCenter">
                                <div class="cbp-l-caption-body">
                ...
                <li class="cbp-item graphic">
                    <a class="cbp-caption cbp-lightbox" data-title="Image" href="storage/profiles/kouchi.jpg">
                        <div class="cbp-caption-defaultWrap">
                            <img src="<?php echo e(asset('storage/profiles/kouchi.jpg')); ?>" alt="" class="img-responsive">
                        </div>
                        <div class="cbp-caption-activeWrap">
                            <div class="cbp-l-caption-alignCenter">
                                <div class="cbp-l-caption-body">
                ...
                <li class="cbp-item web-design">
                    <a class="cbp-caption cbp-lightbox" data-title="Image" href="storage/profiles/hukuoka.jpg">
                        <div class="cbp-caption-defaultWrap">
                            <img src="<?php echo e(asset('storage/profiles/hukuoka.jpg')); ?>" alt="" class="img-responsive">
                        </div>
                        <div class="cbp-caption-activeWrap">
                            <div class="cbp-l-caption-alignCenter">
                                <div class="cbp-l-caption-body">
                ...
                <li class="cbp-item identity">
                    <a class="cbp-caption cbp-lightbox" data-title="Image" href="storage/profiles/shisa.jpg">
                        <div class="cbp-caption-defaultWrap">
                            <img src="<?php echo e(asset('storage/profiles/shisa.jpg')); ?>" alt="" class="img-responsive">
                        </div>
                        <div class="cbp-caption-activeWrap">
                            <div class="cbp-l-caption-alignCenter">
                                <div class="cbp-l-caption-body">
        ...
        <section id="end" class="section-footer">
            <?php echo $__env->make('mains.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </section>
        ...
        <script src="<?php echo e(asset('js/photostack.js')); ?>"></script>
...
</html><?php /**PATH C:\xampp\htdocs\laravel-travel\resources\views/mains/travel.blade.php ENDPATH**/ ?>