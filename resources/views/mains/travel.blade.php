...
<body>
    ...
    <section id="photostack-1" class="photostack photostack-start">
        <div>
            ...
            <figure data-dummy>
                <a href="#" class="photostack-img"><img src="{{ asset('storage/profiles/tokyo.jpg') }}" alt="img07" /></a>
                <figcaption>
                    <h2 class="photostack-title">Tokyo</h2>
                </figcaption>
            </figure>
            <figure data-dummy>
                <a href="#" class="photostack-img"><img src="{{ asset('storage/profiles/IMG_0119.JPG') }}" alt="img08" /></a>
                <figcaption>
                    <h2 class="photostack-title">Hyogo</h2>
                </figcaption>
            </figure>
            <figure data-dummy>
                <a href="#" class="photostack-img"><img src="{{ asset('storage/profiles/IMG_0815.JPG') }}" alt="img10" /></a>
                <figcaption>
                    <h2 class="photostack-title">Hiroshima</h2>
                </figcaption>
                <figure data-dummy>
                    <a href="#" class="photostack-img"><img src="{{ asset('storage/profiles/DSC_0188.JPG') }}" alt="img09" /></a>
                    <figcaption>
            ...
            <ul>
                ...
                <li class="cbp-item identity">
                    <a class="cbp-caption cbp-lightbox" data-title="Image" href="storage/profiles/IMG_0119.JPG">
                        <div class="cbp-caption-defaultWrap">
                            <img src="{{ asset('storage/profiles/IMG_0119.JPG') }}" alt="" class="img-responsive">
                        </div>
                        <div class="cbp-caption-activeWrap">
                            <div class="cbp-l-caption-alignCenter">
                                <div class="cbp-l-caption-body">
